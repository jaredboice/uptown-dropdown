...
UptownDropdown.propTypes = {
    ...
    calculateDimension: PropTypes.bool, // when true (and when anime is true), during animations uptown-dropdown will calculate and apply the body height (or the width with a future orientation update) when expanded and apply 0 on collapse
